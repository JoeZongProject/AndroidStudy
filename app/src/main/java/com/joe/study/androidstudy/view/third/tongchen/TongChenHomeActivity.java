package com.joe.study.androidstudy.view.third.tongchen;
...
public class TongChenHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tong_chen_home);
